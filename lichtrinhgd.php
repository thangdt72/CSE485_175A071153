    ...
    <main>
        <div class="container">
                <div class="col-sm-10">
                    ...
                    <form action="capnhatlt.php?id=<?php echo $laymagv?>&monhoc=<?php echo $laymamon?>&lophoc=<?php echo $laymalop?>" method="post" name="regform" id="regform" onsubmit="return checked();">
